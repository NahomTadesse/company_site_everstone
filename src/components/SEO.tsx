...
const SEO: React.FC<SEOProps> = ({
  title = 'Everstone Technologies',
  description = 'Everstone Technologies Technologies: Pioneering smart engineering solutions with textile sensors for sports, safety, and performance monitoring.',
  type = 'website',
  name = 'Everstone Technologies Technologies',
  ...
  const currentUrl = `https://Everstone Technologies.com${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith('http') ? imageUrl : `https://Everstone Technologies.com${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    '@type': 'Organization',
    name: 'Everstone Technologies Technologies',
    url: 'https://Everstone Technologies.com',
    logo: 'https://Everstone Technologies.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
    description: 'Pioneering smart engineering solutions with textile sensors',
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer service',
      email: 'info@Everstone Technologies.com'
    },
    sameAs: [
      'https://www.linkedin.com/company/Everstone Technologies-technologies',
      'https://twitter.com/Everstone Technologiestechnologies'
    ]
  };
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    author: {
      '@type': 'Organization',
      name: author || 'Everstone Technologies Technologies',
      url: 'https://Everstone Technologies.com'
    },
    publisher: {
      '@type': 'Organization',
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://Everstone Technologies.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
        width: 512,
        height: 512
      },
      url: 'https://Everstone Technologies.com'
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Everstone Technologies Technologies" />
      <meta property="og:locale" content="en_US" />
      {isBlogPost && category && <meta property="article:section" content={category} />}
      {isBlogPost && publishDate && <meta property="article:published_time" content={publishDate} />}
      {isBlogPost && modifiedDate && <meta property="article:modified_time" content={modifiedDate} />}
      {isBlogPost && <meta property="article:publisher" content="https://Everstone Technologies.com" />}
      ...
      <meta name="twitter:site" content="@Everstone Technologiestechnologies" />
      <meta name="twitter:creator" content="@Everstone Technologiestechnologies" />
